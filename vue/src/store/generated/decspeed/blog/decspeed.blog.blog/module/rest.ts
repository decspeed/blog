...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/decspeed/blog/blog/comment
   */
  queryCommentAll = (
    query?: {
    ...
    this.request<BlogQueryAllCommentResponse, RpcStatus>({
      path: `/decspeed/blog/blog/comment`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/decspeed/blog/blog/comments/{id}
   */
  queryComments = (
    id: string,
    query?: {
    ...
    this.request<BlogQueryCommentsResponse, RpcStatus>({
      path: `/decspeed/blog/blog/comments/${id}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/decspeed/blog/blog/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<BlogQueryParamsResponse, RpcStatus>({
      path: `/decspeed/blog/blog/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/decspeed/blog/blog/posts
   */
  queryPosts = (
    query?: {
      "pagination.key"?: string;
